...
public class Employee extends AggregateRoot<EmployeeID> {
    ...
    @Builder
    public Employee(EmployeeID employeeID, EmployerID employerID, String name, String cpf, String position, String hours, BigDecimal salary, AtivoInativo situacao, LocalDate dataInativacao) {
        super(employeeID);
