package br.com.frontier.core.jwt.infrastructure.rest;

import br.com.frontier.core.jwt.JwtUtils;
import br.com.frontier.core.jwt.infrastructure.dtos.CreateUserWithEnployerRequest;
import br.com.frontier.employer.application.create.CreateEmployerInput;
import br.com.frontier.employer.application.create.CreateEmployerUseCase;
...
import br.com.frontier.user.infrastructure.dtos.LoginUserRequest;
import br.com.frontier.user.infrastructure.dtos.LoginUserResponse;
import br.com.frontier.user.infrastructure.queries.getbyemailandpassword.GetUserByEmailAndPasswordOutput;
import br.com.frontier.user.infrastructure.queries.getbyemailandpassword.GetUserByEmailAndPasswordUseCase;
