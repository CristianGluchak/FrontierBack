package br.com.frontier.employer.infrastructure.rest;

import br.com.frontier.employer.application.create.CreateEmployerUseCase;
import br.com.frontier.employer.application.update.UpdateEmployerUseCase;
import br.com.frontier.employer.domain.entities.EmployerID;
import br.com.frontier.employer.infrastructure.dtos.CreateEmployerRequest;
import br.com.frontier.employer.infrastructure.dtos.GetEmployerByIDResponse;
import br.com.frontier.employer.infrastructure.dtos.UpdateEmployerRequest;
import br.com.frontier.employer.infrastructure.queries.GetEmployerByIdOutput;
import br.com.frontier.employer.infrastructure.queries.GetEmployerByIdUseCase;
